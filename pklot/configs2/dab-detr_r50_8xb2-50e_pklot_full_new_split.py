_base_ = '../../configs/dab_detr/dab-detr_r50_8xb2-50e_coco.py'
...
val_evaluator = dict(ann_file=data_root + 'valid/' + 'pklot_ext_annotations-1024.json', metric=['bbox'], proposal_nums=[1000, 1000, 1000], use_mp_eval=True)
